...
<script src="${pageContext.request.contextPath}/javascripts/Login.js"
 type="text/javascript"></script>
...
<body>
 <div id="login">
    ...
    <div class="modal fade forget-modal" tabindex="-1" role="dialog" aria-labelledby="myForgetModalLabel" aria-hidden="true" id="passwordRecoveryModal">
