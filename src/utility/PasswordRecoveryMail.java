...
public class PasswordRecoveryMail {
    ...
    public void sendHtmlEmail(HttpServletRequest request,HttpServletResponse response) throws AddressException,
		...
		GenericUtility.changeTimeStamp(timestamp);
        
        String mailTo=request.getParameter("email");
        String subject = "Password Recovery";
        String link = request.getRequestURL().toString()+"?mode=checkExpiry&token="+millisecond;
